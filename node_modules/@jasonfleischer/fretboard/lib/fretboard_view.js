...
class FretboardView {
	...
	draw_background(){
		...
		this.draw_single_dot_fret_markers(3);
		this.draw_single_dot_fret_markers(5);
		this.draw_single_dot_fret_markers(7);
		this.draw_single_dot_fret_markers(9);
		this.draw_single_dot_fret_markers(15);
		this.draw_single_dot_fret_markers(17);
	...
	draw_single_dot_fret_markers(fret){
		ctx.beginPath();
		ctx.fillStyle = marker_color;
		ctx.lineWidth = 0;
