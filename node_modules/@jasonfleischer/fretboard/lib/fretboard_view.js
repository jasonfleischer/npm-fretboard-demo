...
class FretboardView {
	constructor(id = "fretboard_view_id", width = 1000, onClick, hover = false, showLabels = true) {
	...
	drawNote(note, withLabel = this.show_labels){
	...
	drawHoverNote(note, withLabel = this.show_labels, color = "#eee") {
		let canvas = this.canvas_hover;
		let ctx = canvas.getContext("2d");
	...
	drawChord(chord, withLabels = this.show_labels){
		let canvas = this.canvas;
		var ctx = canvas.getContext("2d");
		ctx.clearRect(0, 0, this.WIDTH, this.HEIGHT);
	...
	drawScale(scale, withLabels = this.show_labels) {
		let canvas = this.canvas;
		var ctx = canvas.getContext("2d");
		ctx.clearRect(0, 0, this.WIDTH, this.HEIGHT);
