...
class FretboardView {
	...
	draw_background(){
		...
		this.draw_single_dot_fret_markers(ctx, 3, marker_color);
		this.draw_single_dot_fret_markers(ctx, 5, marker_color);
		this.draw_single_dot_fret_markers(ctx, 7, marker_color);
		this.draw_single_dot_fret_markers(ctx, 9, marker_color);
		this.draw_single_dot_fret_markers(ctx, 15, marker_color);
		this.draw_single_dot_fret_markers(ctx, 17, marker_color);
	...
	draw_single_dot_fret_markers(ctx, fret, marker_color){
		ctx.beginPath();
		ctx.fillStyle = marker_color;
		ctx.lineWidth = 0;
