		   ...
		   // let clickPoint = new Point(x, y);
		    ...
		    for (const [key, value] of Object.entries(dict)) {
		    	...
		    	for (let i = 0; i < value.length; i++) {
 					...
 					log.e("d "+ distanceBetweenPoints(note_positions.x, note_positions.y, x, y));
 					if (distanceBetweenPoints(note_positions.x, note_positions.y, x, y) < rad) {
			...
			if(foundMidiValue != -1){
				this.drawNote(musicKit.all_notes[foundMidiValue]);
			} else {
				log.e("no note found");
			}
		});
