...
class FretboardView {
	...
	draw_background(){
		...
		draw_single_dot_fret_markers(ctx, fret){
			ctx.beginPath();
		...
		this.draw_single_dot_fret_markers(ctx, 3);
		this.draw_single_dot_fret_markers(ctx, 5);
		this.draw_single_dot_fret_markers(ctx, 7);
		this.draw_single_dot_fret_markers(ctx, 9);
		this.draw_single_dot_fret_markers(ctx, 15);
		this.draw_single_dot_fret_markers(ctx, 17);
